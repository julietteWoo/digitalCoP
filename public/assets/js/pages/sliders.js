...
$(document).ready(function() {
	...
	$("#slider-show-val_1").bootstrapSlider({
		id: 'slider-success',
		max: 100,
		value: 0,
		step: 5
	});
	$("#slider-show-val_1").on("slide", function(slideEvt) {
		$("#sum_1").text(slideEvt.value + '%');
	});

	$("#slider-show-val_2").bootstrapSlider({
		id: 'slider-success',
		max: 100,
		value: 0,
		step: 5
	});
	$("#slider-show-val_2").on("slide", function(slideEvt) {
		$("#sum_2").text(slideEvt.value + '%');
	});

	$("#slider-show-val_3").bootstrapSlider({
		id: 'slider-success',
		max: 100,
		value: 0,
		step: 5
	});
	$("#slider-show-val_3").on("slide", function(slideEvt) {
		$("#sum_3").text(slideEvt.value + '%');
	});

	$("#slider-show-val_4").bootstrapSlider({
		id: 'slider-success',
		max: 100,
		value: 0,
		step: 5
	});
	$("#slider-show-val_4").on("slide", function(slideEvt) {
		$("#sum_4").text(slideEvt.value + '%');
	});

	$("#slider-show-val_5").bootstrapSlider({
		id: 'slider-success',
		max: 100,
		value: 0,
		step: 5
	});
	$("#slider-show-val_5").on("slide", function(slideEvt) {
		$("#sum_5").text(slideEvt.value + '%');
	});
